...
//DATAFILE
img1 = fs.readFileSync('./gambar/thumbs.jpg')
img2 = fs.readFileSync('./gambar/fake_1.jpg')
fakeyoi = ["Public Bot Whatsapp"]
...
Lexxy.sendMessage(from, teks, image, {thumbnail:fs.readFileSync('./gambar/fake_1.jpg'),quoted:mek,caption:yes})
} 
...
//FAKE TEXT
const ftt = {
key: {fromMe: false ,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${fakeyoi}`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync('./gambar/fake_1.jpg')}}}
//FAKE VIDEO
const flexx = {
key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '-99999', 'caption': `${fakeyoi}`,'jpegThumbnail': fs.readFileSync('./gambar/fake_1.jpg')}}}
//FAKE GRUP
const fgc = {
key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fakeyoi}`, 'jpegThumbnail': fs.readFileSync('./gambar/fake_1.jpg')}}}
//FAKE FTROL
const ftrol = {
key: {fromMe: true,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "60139571124@s.whatsapp.net" } : {})},message: {orderMessage: {itemCount : 2005,status: 1,surface : 1,message: `${owner}`,orderTitle: 'Bang',thumbnail: fs.readFileSync('./gambar/fake_1.jpg'), sellerJid: '0@s.whatsapp.net'}}}
//FAKE TROLI
const ftroli = {
key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "60139571124@s.whatsapp.net" } : {})},message: {orderMessage: {itemCount : 2005,status: 1,surface : 1,message: `${owner}`,orderTitle: 'Bang',thumbnail: fs.readFileSync('./gambar/fake_1.jpg'), sellerJid: '0@s.whatsapp.net'}}}
//FAKEREPLY VIDEO
//=================( SEND KONTAK )=================//
...
case 'sewabot':
case 'sewa':
sg = fs.readFileSync('./gambar/ppsewas.jpg')
sw =`┏━━━━━━━━━━━━━━⬣
┃        〔 SEWA BOT  〕
┃▰▰▰▰▰▰▰▰▰▰▰▰▰▰
┃⬣ SEWA + PREM ⬣
...
sw2 =`${time}`
but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: '️OWNER 👑' }, type: 1 },{ buttonId: `${prefix}menu`, buttonText: { displayText: '️BACK 🔙' }, type: 1 }
]
...
but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: '️𝗢𝘄𝗻𝗲𝗿️' }, type: 1 },
{ buttonId: `${prefix}sewabot`, buttonText: { displayText: '️𝗦𝗲𝘄𝗮 𝗕𝗼𝘁🛒' }, type: 1 }
]
...
case 'gheayubi':
case 'nantalia':
gay = fs.readFileSync('./hai.mp3')
sticWait(from)
Lexxy.sendMessage(from, gay, audio, { mimetype: 'audio/mp4', ptt:true })
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: '𝗡𝗶𝗵'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: '𝗡𝗶𝗵'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: '𝗡𝗶𝗵'})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: '𝗡𝗶𝗵',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
if (!isPremier)return reply(mess.premier)
if (isBanned)return sticBanned(from)
qute = fs.readFileSync('./gambar/fake_1.jpg') 
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: '𝗡𝗶𝗵'})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `𝗡𝗶𝗵`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
Lexxy.sendMessage(from, girlneko, image, {caption: `𝗡𝗶𝗵`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
break
case 'donasi':
dno = fs.readFileSync('./gambar/ppsewas.jpg')
dns =`${(ind.donasi())}`
...
break
case 'pyment':
pyg = fs.readFileSync('./gambar/ppsewas.jpg')
...
fs.writeFileSync(`./gambar/fake_1.jpg`, delb)
reply('Sukses')
} else {
...
Lexxy.sendMessage(from, zks, image, { quoted: flexx, thumbnail: fs.readFileSync('./gambar/fake_1.jpg')})
break
case 'blackpink':
case 'neon_light':
case 'gaming':
...
Lexxy.sendMessage(from, jojo, image, { quoted: flexx, thumbnail: fs.readFileSync('./gambar/fake_1.jpg')})
break
case 'tes':
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage('${owner}@s.whatsapp.net', options, text, {quoted: flexx})
reply('Reort Telah Dikirimkan Kepada Owner, Report palsu atau main² tidak akan ditanggapi.')
break
case 'broadcast':
case 'bc':
if (!isOwner) return sticOwner(from)
...
Lexxy.sendMessage(from, buffer, image, { quoted: mek, thumbnail: fs.readFileSync('./gambar/fake_1.jpg')})
break
case 'public':
...
but = [
{ buttonId: `${prefix}gitown`, buttonText: { displayText: 'GITHUB' }, type: 1 },
{ buttonId: `${prefix}ytown`, buttonText: { displayText: '️WEBSITE?' }, type: 1 }
]
...
sendButton(from, `*MODE ANTILINK*/n𝙰𝚗𝚝𝚒𝚕𝚒𝚗𝚔`, `Silahkan pilih salah satu`, [
